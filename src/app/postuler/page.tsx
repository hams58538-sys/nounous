  ...
  return (
    <div className="mx-auto max-w-2xl px-5 py-12">
      <h1 className="font-display text-3xl font-semibold text-eden-green">
        Postuler comme nounou ou ménagère
      </h1>
      <p className="mt-2 text-eden-ink/70">
        Remplissez le formulaire ci-dessous. Vos documents sont stockés de
        façon sécurisée et privée — ils ne sont jamais partagés par WhatsApp.
        Après l&apos;envoi, vous pourrez continuer la conversation sur WhatsApp.
      </p>
      <ApplyForm />
    </div>
  );
