...
export default function HomePage() {
  return (
    <>
      ...
      >
        <div className="mx-auto max-w-6xl bg-eden-cream/70 px-5 pb-16 pt-16 text-center backdrop-blur-[12px] [-webkit-backdrop-filter:blur(12px)] sm:pt-24">
          <Image
            src="/logo-full.png"
          ...
          <h1 className="mt-4 font-display text-4xl font-semibold text-eden-green sm:text-6xl">
            Placement de <span className="text-eden-pink">Nounous</span> & <span className="text-eden-blue">Ménagères</span>
          </h1>
          <p className="mt-3 font-display text-2xl text-eden-ink sm:text-3xl">à Douala et Yaoundé</p>
          ...
          <div className="mt-10">
            <p className="mb-4 text-sm font-medium text-eden-ink/70">Choisissez votre ville pour commencer :</p>
            <CitySelector />
          </div>
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <Link href="/demande" className="rounded-full bg-eden-green px-6 py-3 font-semibold text-eden-cream transition hover:bg-eden-green-light">
              Faire une demande de placement
            </Link>
            <Link href="/postuler" className="rounded-full border-2 border-eden-green px-6 py-3 font-semibold text-eden-green transition hover:bg-eden-green hover:text-eden-cream">
